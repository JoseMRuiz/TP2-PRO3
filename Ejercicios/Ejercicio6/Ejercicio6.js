...
const validar = () =>{
    ...
    if(nombreV !== "" && apellidoV !== "" && nombreV.length < 50 && apellidoV.length < 50){
        ...
        validar1.textContent = "El nombre y apellido estan bien";
    } else{
    ...
    if(edadV > 18){
        ...
        validar2.textContent = "La edad esta bien";
    }else{
    ...
    if(alturaV > 0 && alturaV < 230){
        ...
        validar3.textContent = "La altura esta bien";
    }else{
    ...
    if(correoV.length > 0 && correoV.includes("@")){
        ...
        validar4.textContent = "El correo electrónico esta bien";
    }else{
